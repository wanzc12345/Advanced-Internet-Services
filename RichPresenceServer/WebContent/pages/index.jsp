        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bell fa-fw"></i> Informations on device
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="list-group">
                                <% GetUsers gu1 = new GetUsers();
                                    ArrayList<String> al1 = gu1.get_users();
                                  //  out.print(al);
                            		for (int i = 0; i < al1.size(); i++){
                         		 %>
                       		 <li>
                            <i class="nav nav-second-level"></i> <% out.print(al1.get(i)); %>
                        	</li>
                        <% }%>
                            </div>
                            <!-- /.list-group -->
